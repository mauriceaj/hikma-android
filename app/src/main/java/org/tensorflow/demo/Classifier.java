...
public interface Classifier {
  ...
  public class Recognition {
    ...
    public Recognition(
        final String id, final String title, final Float confidence, final RectF location, final String arabic_title) {
      this.id = id;
      this.title = title;
    ...
    public String getArabic_title() { return arabic_title; }
