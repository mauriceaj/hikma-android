...
class TensorFlowClassifier implements Classifier {
  ...
  private final String[] class_labels =  {"aeroplane", "bicycle", "bird", "boat", "bottle", "bus", "car",
          ...
          "plant", "sheep", "sofa", "train", "television"};

  private final String[] class_labels_arabic =  {"طائرة", "دراجة", "عصفور", "باخرة", "قنينة", "حافلة", "سيّارة",
          "هر", "كرسي", "بقرة", "طاولة", "كلب", "حصان", "دراجة ناريّة", "شخص",
          "نبات", "خروف", "أريكة", "قطار","تلفاز"};
  ...
  public List<Recognition> recognizeImage(final Bitmap bitmap) {
    ...
    recognitions.add(new Recognition("Prediction ", class_labels[predicted_class], highest_prob, boundingBox, class_labels_arabic[predicted_class]));
    Trace.endSection();
    return recognitions;
  }
